...
public:
	...
	virtual void batch_function(double** dest, double** const& src) = 0;
	virtual void batch_function_prime(double** dest, double** const& src) = 0;
};
...
public:
	...
	virtual void batch_function(double** dest, double** const& src) {
	...
	virtual void batch_function_prime(double** dest, double** const& src) {
		for (int m = 0; m < batch_size; m++) {
			for (int i = 0; i < len; i++) {
				if (src[m][i] >= 0) {
